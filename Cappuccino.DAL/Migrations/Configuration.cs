...
namespace Cappuccino.DAL.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<Cappuccino.DAL.EfDbContext>
    {
        ...
        protected override void Seed(Cappuccino.DAL.EfDbContext context)
        {
            ...
            {
                new SysActionEntity{Id=2,Name="用户管理",Code="system.user.list",ParentId=systemMenu.Id,Type=0,SortCode=1
                ,SysActionMenu=new SysActionMenuEntity{Icon="layui-icon-face-cry",Url="/System/SysUser" }
                ,CreateTime=DateTime.Now,UpdateTime=DateTime.Now,CreateUserId=1,UpdateUserId=1},
                new SysActionEntity{Id=3,Name="角色管理",Code="system.role.list",ParentId=systemMenu.Id,Type=0,SortCode=2
                ,SysActionMenu=new SysActionMenuEntity{Icon="layui-icon-face-cry",Url="/System/SysRole" }
                ,CreateTime=DateTime.Now,UpdateTime=DateTime.Now,CreateUserId=1,UpdateUserId=1},
                new SysActionEntity{Id=4,Name="菜单管理",Code="system.menu.list",ParentId=systemMenu.Id,Type=0,SortCode=3
                ,SysActionMenu=new SysActionMenuEntity{Icon="layui-icon-face-cry",Url="/System/SysAction" }
                ,CreateTime=DateTime.Now,UpdateTime=DateTime.Now,CreateUserId=1,UpdateUserId=1},
                new SysActionEntity{Id=5,Name="数据字典",Code="system.dict.list",ParentId=systemMenu.Id,Type=0,SortCode=4
            ...
            {
                new SysActionEntity{Id=7,Name="登录日志",Code="system.log.logon",ParentId=systemMenuSystemLog.Id,Type=0,SortCode=6
            ...
            var sysActionByButton = new List<SysActionEntity>
            {
                ...
                new SysActionEntity{Id=26,Name="导出",Code="system.log.logon.export",ParentId=systemMenuSystemLogLogon.Id,Type=ActionTypeEnum.Button,SortCode=1,
